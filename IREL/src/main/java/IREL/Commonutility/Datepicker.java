...
public class Datepicker extends testbase {
	...
	static List<String> monthlist = Arrays.asList("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct",
			"Nov", "Dec");

	public void datepicker(String expDatemonthYear) {
		String[] mmddyyyy = expDatemonthYear.split("/", -2);
		...
		while (dateNotFound) {
			...
			WebElement picyear = driver.findElement(
					By.cssSelector("div.datepicker-months>table.table.table-condensed>thead>tr>th.datepicker-switch"));
			...
			if (Integer.parseInt(calYear) == expYear) {
				...
				driver.findElement(By.cssSelector("div.datepicker-months>table.table.table-condensed>thead>tr>th.next"))
						.click();
			}

			else if (Integer.parseInt(calYear) > expYear) {
				// clicking on the left arrow
				driver.findElement(By.cssSelector("div.datepicker-months>table.table.table-condensed>thead>tr>th.prev"))
						.click();
			}
