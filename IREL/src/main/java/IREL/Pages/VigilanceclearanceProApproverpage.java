...
public class VigilanceclearanceProApproverpage extends testbase {
	...
	public VigilanceclearanceProApproverpage() {
	...
	public void Submit() throws InterruptedException {
		...
		Remark.sendKeys("good");
		Thread.sleep(6000);
		select(status, "Forward With Recommendation");
		Thread.sleep(3000);
		Sumit.click();
