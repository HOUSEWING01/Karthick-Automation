...
public class SickleaveRequestorpage extends testbase {
...
@FindBy(xpath = "//textarea[@name='description']")
	...
	public void Sickleavereset() throws InterruptedException {
		Thread.sleep(3000);
		ApplyForLeave.click();
		select(leavetype, prop.getProperty("leave6"));
		Thread.sleep(3000);
		fromDate.sendKeys("06/19/2022");
		Thread.sleep(3000);
		toDate.sendKeys("06/20/2022");
		Thread.sleep(3000);
		...
		// select(hi, prop.getProperty("handle"));
		Thread.sleep(3000);
		reset.click();
		Thread.sleep(3000);
	}

	public void Sickleavesubmit() throws InterruptedException {
		Thread.sleep(3000);
		ApplyForLeave.click();
		select(leavetype, prop.getProperty("leave6"));
		Thread.sleep(3000);
