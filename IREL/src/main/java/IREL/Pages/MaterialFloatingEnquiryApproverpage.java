...
public class MaterialFloatingEnquiryApproverpage  extends testbase{
	...
	@FindBy(xpath = "//a[contains(text(),' Notice Inviting Tender Approver')]")
	WebElement  TenderApprover;
	...
	public MaterialFloatingEnquiryApproverpage() {
